...
func (s *PersonalAccountAPI) signTransaction(ctx context.Context, args *TransactionArgs, passwd string) (*types.Transaction, error) {
	...
	if header != nil && s.b.ChainConfig().IsEtntPoWFork(header.Number) {
		chainId = s.b.ChainConfig().ChainID_ETNT
	}
...
func (api *BlockChainAPI) ChainId() *hexutil.Big {
	...
	if header != nil && api.b.ChainConfig().IsEtntPoWFork(header.Number) {
		return (*hexutil.Big)(api.b.ChainConfig().ChainID_ETNT)
	}
...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	...
	if b.ChainConfig().IsEtntPoWFork(b.CurrentBlock().Number()) && !tx.Protected() {
