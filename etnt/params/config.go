...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		EtntPoWForkBlock:    big.NewInt(15_537_394),
		EthPoWForkSupport:   true,
		EtntCJPoWForkBlock:  big.NewInt(18_092_792), //BWCJ
		// EtntCJPoWForkSupport:    true,                   //BWCJ
		ChainID_ETNT:            big.NewInt(160160160), //10001
	...
	SepoliaChainConfig = &ChainConfig{
		...
		ChainID_ETNT:                  big.NewInt(11155111),
	...
	RinkebyChainConfig = &ChainConfig{
		...
		ChainID_ETNT:        big.NewInt(4), //10001
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, false, nil, big.NewInt(1337), nil, false, new(EthashConfig), nil} //
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, false, nil, big.NewInt(1337), nil, false, nil, &CliqueConfig{Period: 0, Epoch: 30000}}

	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, false, nil, big.NewInt(1), nil, false, new(EthashConfig), nil}
...
type ChainConfig struct {
	...
	EtntPoWForkBlock    *big.Int `json:"etntPoWForkBlock,omitempty"`    //EthPoW hard-fork switch block (nil = no fork)
	EthPoWForkSupport   bool     `json:"ethPoWForkSupport,omitempty"`   // Whether the nodes supports or opposes the EthPoW hard-fork
	EtntCJPoWForkBlock  *big.Int `json:"etntCJPoWForkBlock,omitempty"`  //EthPoW hard-fork switch block (nil = no fork)
	// EtntCJPoWForkSupport bool     `json:"entCJPoWForkSupport,omitempty"` // Whether the nodes supports or opposes the EthPoW hard-fork

	ChainID_ETNT *big.Int `json:"chainID_ETNT"` // chainId alt identifies the current chain after pos switch and is used for replay protection
...
func (c *ChainConfig) String() string {
	...
	if c.EtntPoWForkBlock != nil {
		banner += fmt.Sprintf(" - EtntPoW:                      %-8v\n", c.EtntPoWForkBlock)
	}
	if c.EtntCJPoWForkBlock != nil {
		banner += fmt.Sprintf(" - EtntCJPoW:                      %-8v\n", c.EtntCJPoWForkBlock)
	}
	banner += "\n"
...
// IsEtntPoWFork returns whether num is either equal to the EtntPoWFork fork block or greater.
func (c *ChainConfig) IsEtntPoWFork(num *big.Int) bool {
	return isForked(c.EtntPoWForkBlock, num)
}

// IsEtntCJPoWFork returns whether num is either equal to the EtntCJPoWFork fork block or greater.
func (c *ChainConfig) IsEtntCJPoWFork(num *big.Int) bool {
	return isForked(c.EtntCJPoWForkBlock, num)
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	for _, cur := range []fork{
		...
		{name: "EtntPoWForkBlock", block: c.EtntPoWForkBlock, optional: true},
		{name: "EtntCJPoWForkBlock", block: c.EtntCJPoWForkBlock, optional: true},
	} {
		if lastFork.name != "" {
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, head *big.Int) *ConfigCompatError {
	...
	if isForkIncompatible(c.EtntPoWForkBlock, newcfg.EtntPoWForkBlock, head) {
		return newCompatError("EtntPoW fork block", c.EtntPoWForkBlock, newcfg.EtntPoWForkBlock)
	}
	if c.IsEtntPoWFork(head) && c.EthPoWForkSupport != newcfg.EthPoWForkSupport {
		return newCompatError("EtntPoW fork support flag", c.EtntPoWForkBlock, newcfg.EtntPoWForkBlock)
	}
	if isForkIncompatible(c.EtntCJPoWForkBlock, newcfg.EtntCJPoWForkBlock, head) {
		return newCompatError("EtntCJPoW fork block", c.EtntCJPoWForkBlock, newcfg.EtntCJPoWForkBlock)
	}
	return nil
}
...
type Rules struct {
	...
	IsMerge, IsShanghai, isCancun, IsEtntPoWFork, IsEtntCJPoWFork bool
}
...
func (c *ChainConfig) Rules(num *big.Int, isMerge bool) Rules {
	...
	return Rules{
		...
		IsEtntPoWFork:    c.IsEtntPoWFork(num),
		IsEtntCJPoWFork:  c.IsEtntCJPoWFork(num),
	}
}
